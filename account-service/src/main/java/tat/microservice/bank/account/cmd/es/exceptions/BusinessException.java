...
##############################################################################*/
package tat.microservice.bank.account.cmd.es.exceptions;

import tat.microservice.bank.account.cmd.es.errors.DefaultError;
import tat.microservice.bank.account.cmd.es.errors.IError;
