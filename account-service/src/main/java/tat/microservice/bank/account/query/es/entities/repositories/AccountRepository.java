...
public interface AccountRepository extends JpaRepository<AccountQueryEntity, String> {
    ...
    Iterable<AccountQueryEntity> findAllByOrderByIdAsc();
    AccountQueryEntity findOneByAccountId(String accountId);
    //AccountQueryEntity findOneByCustomerSsn(String customerSsn);
    List<AccountQueryEntity> findByCustomerSsn(String customerSsn);
}
